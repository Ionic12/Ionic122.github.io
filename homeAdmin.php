<html>
	...
	<div class="container">
		...
		<tr>
			...
			<td>
				<a href="editForm.php?noun=<?php echo $row['noun']; ?>"> Edit &nbsp; </a>
				<a href="hapus.php?noun=<?php echo $row['noun']; ?>"> Hapus </a>
			</td>
		<?php
				}
			}
	...
	<button onclick="window.location.href='formData.html';" class="btn btn-primary btn-block" style="width: 150px;">Tambah Data</button>
</body>
</html>
